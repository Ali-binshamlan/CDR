    ...
    <div className="space-y-6 animate-fadeIn">
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        {/* النشاط التنظيمي المُختار في الشاشة السابقة — موقعه يُحدَّد من
            ...
            كمدخلات حقيقية — راجع GENERAL_ALERTS_AR في constants.ts). */}
                ...
                <div className="rounded-xl border border-[#061B40]/10 overflow-hidden">
                  <div className="flex items-center justify-between bg-[#F4F7FB] px-4 py-3">
                    ...
                    <div className="p-4 space-y-4 bg-white">
                      ...
                      {/* الحقول التي بقيت مدخلات حقيقية — راجع تعليق
                          GENERAL_ALERTS_AR في constants.ts لتبرير الإبقاء
                          عليها تحديداً */}
                      ...
                      {/* checkbox الرش المائي/HEPA لقطع الأحجار أُضيف مؤقتاً
                          ثم حُذف (طلب صريح من المستخدم — "لا نريدها تدخل في
                          الايقاف احذف المدخلات و حولها تنبيهات"): STONECUT-
                          DUST-CONTROL-006 لم تعد قاعدة قرار فعلية، فلا حاجة
                          لحقل إدخال يغذّيها — النص التوعوي في GENERAL_ALERTS_AR
                          أعلاه (قسم STONE_CUTTING) كافٍ الآن، بلا أي تأثير
                          على decisionCategory. */}
                    </div>
                </div>
            );
          })()}
