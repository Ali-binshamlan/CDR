...
export default function RegisterPage() {
  ...
  // راجع تعليق TurnstileWidget.tsx الكامل — null يعني "لم يُحلّ التحدي
  // بعد" (أو Turnstile غير مُفعَّلة، NEXT_PUBLIC_TURNSTILE_SITE_KEY غائب).
              ...
              <div className="mt-auto pt-8">
                <div className="flex justify-between gap-4">
                  ...
                  <motion.button
                    ...
                    // راجع تعليق captchaToken أعلاه — يُشترَط فقط في الخطوة
                    // الأخيرة، وفقط حين Turnstile مُفعَّلة فعلياً (site key
                    // موجود) — بلا ذلك، TurnstileWidget لا تُعرض أصلاً
                    // (return null)، فلا يجوز حجب الإرسال بانتظار توكن لن
                    // يصل أبداً.
                    disabled={
                      isSubmitting ||
                      (step === totalSteps && Boolean(process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY) && !captchaToken)
                    }
