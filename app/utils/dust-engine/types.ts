...
export interface DustEngineInput {
  ...
  // ساعات، هل الجهاز يوقف قراءته في هذه الفترة؟"): ساعات الدوام اليومي وحدها
  // (بمعزل عن duration_hours الإجمالية عبر كل أيام النشاط) — راجع migration
  // 202608110012 وisDustProfileWithinDailyWindow في dustEvaluation.ts (نفس
  // المفهوم، مُعاد بناؤه هنا محلياً لعزل هذا الملف التام عن dustEvaluation.ts).
  // undefined = فشل آمن نحو فترة متصلة واحدة (سلوك duration الإجمالية القديم
  // بلا تغيير)، مطابق تماماً لنشاط بيوم واحد.
