...
export const DUST_RULES_CATALOG: RuleCatalogSection[] = [
  {
    ...
    rules: [
      ...
      },
      {
        code: 'GATE-DVI-002',
        severity: 'MANDATORY_STOP',
        messageAr: 'إيقاف إلزامي بسبب خطورة فيزيائية حالية (رؤية منعدمة أو تركيز غبار خطر) — النص المعروض فعلياً يستبدل هذه الجملة بسبب DVI المحدَّد (مثال: PM10 = ...) عند توفره',
        actionAr: 'أخلِ منطقة العمل وانتظر تحسّن حالة الجو (الرؤية وتركيز الغبار) — لا يمكن استئناف العمل بإجراء تنظيمي',
        noteAr: 'موروثة من إيقاف محرك DVI الفيزيائي (مستقل عن مخالفات تنظيمية)',
      },
      {
    ...
    rules: [
      {
        ...
        severity: 'ALLOW_WITH_CONTROLS',
        messageAr: 'تحذير: تركيز PM10 تجاوز حد التحذير (250 ميكروجرام/م³)',
        actionAr: 'فعّل التثبيط المعزز (رش ساعي، تغطية الأكوام) وراقب التركيز عن كثب',
      },
      {
        code: 'PM10-EARLY-WARNING-007',
        severity: 'ALLOW_WITH_CONTROLS',
        messageAr: 'تنبيه استباقي: تركيز PM10 يقترب من حد المخالفة (300 ميكروجرام/م³، قبل حد 340)',
        actionAr: 'فعّل التثبيط المعزز فوراً (رش/تغطية) لتفادي تجاوز الحد التنظيمي والتعرض لغرامة',
        noteAr: 'إضافة وقائية داخلية (ليست نصاً حرفياً من الدليل) لأن التقييم لحظي لا بث مستمر',
      },
      {
        code: 'PM10-VIOLATION-STOP-006',
        severity: 'STOP_AFFECTED_ACTIVITY',
        messageAr: 'مخالفة تنظيمية: تركيز PM10 تجاوز حد المخالفة (340 ميكروجرام/م³)',
        actionAr: 'أوقف النشاط المسبب للغبار فوراً وفعّل إجراءات التصحيح (تقليل واجهات العمل، خفض ارتفاع التفريغ، تقييد حركة الشاحنات، زيادة الرش) حتى يزول التجاوز',
      },
    ],
  },
  {
