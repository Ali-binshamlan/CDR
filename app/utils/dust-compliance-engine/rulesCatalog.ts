  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        severity: 'ALLOW_WITH_CONTROLS',
        messageAr: 'تنبيه: تعذر إثبات مسافة محطة الخلط عن أقرب مستقبل حساس (لا إحداثيات مُدخلة لموقع المحطة) — تنبيه توعوي فقط، لا يوقف النشاط',
        actionAr: 'يُفضَّل تحديد موقع محطة الخلط على الخريطة للتحقق التلقائي من مسافتها عن أقرب مستقبِل حساس',
        noteAr: 'قرار مُعاد النظر فيه — المستقبلات الحساسة لا تدخل ضمن قرارات الإيقاف',
      },
      {
