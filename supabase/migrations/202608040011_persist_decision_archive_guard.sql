-- =====================================================================
-- DCR — 202608040011_persist_decision_archive_guard.sql
-- =====================================================================
-- القسم 13.2 من "دليل الإصلاح الجذري لمنظومة مرقاب" — نفس قفل المشروع
-- المستخدَم في archive_project_atomic/ingest_device_reading_atomic/
-- ingest_device_event_v2 يُطبَّق هنا أيضاً، قبل قفل النشاط الأضيق الموجود
-- مسبقاً (hashtextextended(project_id||':'||activity_group_id, 0)) —
-- الترتيب الموحَّد (قفل المشروع أولاً، ثم فحص archived_at، ثم قفل النشاط،
-- ثم الكتابة) يمنع Deadlocks وسباق أرشفة/حفظ قرار لنفس المشروع.
-- =====================================================================
...
begin
  ...
  -- سباق أرشفة متزامنة مع حفظ هذا القرار.
  ...
  -- قفل النشاط الأضيق الموجود مسبقاً — يبقى كما هو (يحمي التزامن على مستوى
  -- (project_id, activity_group_id) تحديداً، منفصل عن قفل المشروع الأعم).
  perform pg_advisory_xact_lock(
